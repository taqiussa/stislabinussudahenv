                    ...
                    <div class="m-7">
                        <form class="w-full max-w-sm">
                            ...
                            <div class="relative flex items-center py-2 mb-2 border-b border-teal-500">
                                <select wire:model='idkelas' class="block w-full px-2 py-2 pr-8 leading-tight bg-white border-none appearance-none focus:outline-none">
                            ...
                            @enderror
                            <div class="relative flex items-center py-2 mb-2 border-b border-teal-500">
                                <select wire:model='keterangan_id' class="block w-full px-2 py-2 pr-8 leading-tight bg-white border-none appearance-none focus:outline-none">
                                    <option value=""> Keterangan </option>
                                    @foreach ($keter as $k)
                                    <option value="{{ $k->id }}">{{ $k->ket }} </option>
                                    @endforeach
                                </select>
                                <div class="absolute inset-y-0 right-0 flex items-center px-2 text-gray-700 pointer-events-none">
                                    <svg class="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">

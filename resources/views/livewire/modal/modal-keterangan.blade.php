            ...
            {{-- Your Form Should Inside Down Here --}}
                ...
                <div class="max-w-md p-4 mx-auto my-10 bg-white rounded-md shadow-sm">
                    <div class="text-center">
                        ...
                        <p class="text-gray-400 dark:text-gray-400">Silahkan buat keterangan</p>
                    </div>
                    <div class="m-7">
                        <form class="w-full max-w-sm">
                            ...
                            <div class="relative flex items-center py-2 mb-2 border-b border-teal-500">
                                <input type="hidden" wire:model='idketerangan' id="idketerangan">
                                <input wire:model.defer='ket' class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none" type="text" placeholder="ket" aria-label="ket">
                                @error('ket')
                                    <h1 class="text-red-500">{{ $message }}</h1>
                                @enderror
                            </div>
                            <div class="flex items-center py-2 mb-2 border-b border-teal-500">
                                <input wire:model.defer='jenisket' class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none" type="text" placeholder="jenisket" aria-label="jenisket">
                                @error('jenisket')
                                    <h1 class="text-red-500">{{ $message }}</h1>
                                @enderror
                            </div>
